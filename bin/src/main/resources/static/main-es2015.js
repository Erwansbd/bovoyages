...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"container\">\n  <div>\n    <p id=\"informations\">\n      Liste des dates disponibles pour la destination {{destination.region}}.\n      {{destination.datesVoyage}}\n      {{destination.datesVoyageList}}\n      {{destination.valueOf(datesVoyage)}}\n      {{destination.datesVoyage.prixHT}}\n    </p>\n  </div>\n  <div>\n    <label>\n      <input #datesVoyage> {{datesVoyage.value}}\n    </label>\n    {{destination.region}}\n    {{datesVoyage}}\n  </div>\n</div>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"container\">\n  <div class=\"row\">\n    <div *ngFor=\"let destination of destinations\" class=\"col-12 col-sm-6 col-md-4 col-lg-3\">\n      <a [routerLink]=\"['/destination-details', destination.id]\">\n        {{destination.region}}\n      </a>\n    </div>\n  </div>\n</div>\n<div *ngIf=\"selectedDestination\">\n  <app-destination-details *ngIf=\"selectedDestination\" [destination]=\"selectedDestination\" [datesVoyage]=\"selectedDatesVoyage\"></app-destination-details>\n  <button type=\"button\" (click)=\"unselect()\">Retour</button>\n</div>\n\n");
...
/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/bovoyages/pages/new-destination/new-destination.component.html":
/*!**********************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/bovoyages/pages/new-destination/new-destination.component.html ***!
  \**********************************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<p>new-destination works!</p>\n");
...
/* harmony import */ var _bovoyages_components_navbar_navbar_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./bovoyages/components/navbar/navbar.component */ "./src/app/bovoyages/components/navbar/navbar.component.ts");
/* harmony import */ var _bovoyages_bovoyages_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./bovoyages/bovoyages.module */ "./src/app/bovoyages/bovoyages.module.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _bovoyages_shared_destinations_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./bovoyages/shared/destinations.service */ "./src/app/bovoyages/shared/destinations.service.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            ...
            _bovoyages_components_navbar_navbar_component__WEBPACK_IMPORTED_MODULE_5__["NavbarComponent"]
        ],
        imports: [
            _angular_platform_browser__WEBPACK_IMPORTED_MODULE_10__["BrowserModule"],
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"],
            _bovoyages_bovoyages_module__WEBPACK_IMPORTED_MODULE_6__["BovoyagesModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"],
            _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_9__["NgbModule"]
        ],
        providers: [
            _bovoyages_shared_destinations_service__WEBPACK_IMPORTED_MODULE_8__["DestinationsService"]
        ],
        bootstrap: [
            _app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"]
        ]
...
/* harmony import */ var _pages_new_destination_new_destination_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./pages/new-destination/new-destination.component */ "./src/app/bovoyages/pages/new-destination/new-destination.component.ts");
/* harmony import */ var _pages_destination_destination_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./pages/destination/destination.component */ "./src/app/bovoyages/pages/destination/destination.component.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
...
let BovoyagesModule = class BovoyagesModule {
};
BovoyagesModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            ...
            _pages_new_destination_new_destination_component__WEBPACK_IMPORTED_MODULE_5__["NewDestinationComponent"],
            _pages_destination_destination_component__WEBPACK_IMPORTED_MODULE_6__["DestinationComponent"]
        ],
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2Jvdm95YWdlcy9jb21wb25lbnRzL2Rlc3RpbmF0aW9uLWRldGFpbHMvZGVzdGluYXRpb24tZGV0YWlscy5jb21wb25lbnQuY3NzIn0= */");
...
let DestinationDetailsComponent = class DestinationDetailsComponent {
    constructor(activatedRoute, destinationService, router) {
    ...
    ngOnInit() {
        this.activatedRoute.paramMap.subscribe((map) => {
            const id = +map.get('id');
            this.destinationService.getDestination(id).subscribe(destination => this.destination = destination);
            this.destinationService.getDatesVoyage(id).subscribe(datesVoyage => this.datesVoyage = datesVoyage);
        });
    }
};
DestinationDetailsComponent.ctorParameters = () => [
...
let DestinationListeComponent = class DestinationListeComponent {
    ...
    ngOnInit() {
        ...
        this.destinationService.getDatesVoyages().subscribe((datesVoyageList) => {
            this.datesVoyageList = datesVoyageList;
        });
    }
    selectedDatesVoyage(datesVoyage) {
        this.selectedDatesVoyage = datesVoyage;
    }
...
DestinationListeComponent.ctorParameters = () => [
...
let DestinationComponent = class DestinationComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
/***/ "./src/app/bovoyages/pages/new-destination/new-destination.component.css":
/*!*******************************************************************************!*\
  !*** ./src/app/bovoyages/pages/new-destination/new-destination.component.css ***!
  \*******************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2Jvdm95YWdlcy9wYWdlcy9uZXctZGVzdGluYXRpb24vbmV3LWRlc3RpbmF0aW9uLmNvbXBvbmVudC5jc3MifQ== */");

/***/ }),

/***/ "./src/app/bovoyages/pages/new-destination/new-destination.component.ts":
/*!******************************************************************************!*\
  !*** ./src/app/bovoyages/pages/new-destination/new-destination.component.ts ***!
  \******************************************************************************/
/*! exports provided: NewDestinationComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NewDestinationComponent", function() { return NewDestinationComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let NewDestinationComponent = class NewDestinationComponent {
...
NewDestinationComponent.ctorParameters = () => [
    { type: _shared_destinations_service__WEBPACK_IMPORTED_MODULE_3__["DestinationsService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }
];
NewDestinationComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-new-destination',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./new-destination.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/bovoyages/pages/new-destination/new-destination.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./new-destination.component.css */ "./src/app/bovoyages/pages/new-destination/new-destination.component.css")).default]
    })
...
let DestinationsService = class DestinationsService {
    ...
    getDestinations() {
        return this.httpClient.get('destination/all'); // => GET All Destinations à l'adresse localhost:4200/destination/all
    }
    getDestination(id) {
        return this.httpClient.get('destination/' + id); // GET Destination par id à l'adresse localhost:4200/destination/1
    }
    getDatesVoyages() {
        return this.httpClient.get('dates');
    }
    getDatesVoyage(id) {
        return this.httpClient.get('destination/dates/valid/' + id); // GET DatesVoyage par l'id de la destination
